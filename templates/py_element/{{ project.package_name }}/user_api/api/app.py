...
from {{ project.package_name }}.common.api.middlewares import errors as errors_mw
from {{ project.package_name }}.user_api.api import routes as app_routes
from {{ project.package_name }}.user_api.api import versions
from {{ project.package_name }} import version as app_version
